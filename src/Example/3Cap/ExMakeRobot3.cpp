#ifdef ARDUINO_SIM_EXAMPLE_3

#include <QApplication>
#include "ArduinoSim.h"

// Les composants utilisés :
#include "ExProgramme3.cpp" // Une carte Arduino programmée
...
int main(int argc, char **argv)
{
    ...
    // 1 carte Arduino
    ArduinoProgrammeExemple3 *arduino = new ArduinoProgrammeExemple3();
